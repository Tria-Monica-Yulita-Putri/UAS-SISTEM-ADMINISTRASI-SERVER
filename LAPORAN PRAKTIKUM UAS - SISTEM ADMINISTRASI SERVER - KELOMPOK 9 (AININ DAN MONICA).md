# LAPORAN PRAKTIKUM UAS - SISTEM ADMINISTRASI SERVER - KELOMPOK 9
...
* Setelah itu, buat beberapa file untuk menjalankan konfigurasi yang telah dibuat di directory roles 

  * Buat file dengan nama hosts dan tulis perintah seperti dibawah ini :
  ...
  * Setelah itu buat file dengan nama install-codeigniter.yml. Lalu tulis perintah seperti dibawah ini :
  ...
  * Lalu, langkah selanjutnya buat file dengan nama install-dbserver.yml. Lalu tulis perintah seperti dibawah ini :
  ...
  * Setelah itu buat file dengan nama install-laravel.yml Lalu tulis perintah seperti dibawah ini :
  ...
  * Lalu langkah selanjutnya yaitu, buat file dengan nama install-wordpress.yml. Lalu tulis perintah seperti dibawah ini :
  ...
  * Setelah itu buat file dengan nama install-yii.yml, dan tulis perintah seperti di bawah ini:
...
* Pada directory db dibutuhkan 3 folder untuk menampung handlers, tasks, dan script template yang akan digunakan nantinya dalam menginstall db
  ...
  * Buat beberapa file dengan nama db/handlers/main.yml pada handlers directory dan tulis perintah seperti di bawah ini :
  ...
  * Lalu, langkah selanjutnya yaitu buat beberapa file dengan nama db/task/main.yml pada tasks directory dan tulis perintah seperti di bawah ini :
  ...
  * Lalu, langkah selanjutnya yaitu buat beberapa file dengan nama db/templates/my.cnf pada tasks directory dan tulis perintah seperti di bawah ini :
...
* Langkah selanjutnya yaitu, buat sebuah folder dengan nama pma untuk menginstall pma dengan roles pma. Buat 3 directory dengan nama tasks, handlers dan templates, pada roles. 

  * Pada handlers directory, buat file bernama  pma/handlers/main.yml, lalu tulis perintah berikut :
  ...
  * Pada template directory, buat file bernama pma/templates/pma.local lalu tulis perintah berikut :
...
* Lalu, langkah selanjutnya yaitu, buat directory codeigniter dengan roles directory untuk mengakomodasikan sebuah ansible script dan untuk menginstall codeigniter framework. 

  * Buat file pada directory handlers dengan nama codeigniter/handlers/main.yml , lalu isi perintah sebagai berikut :
  ...
  * Lalu langkah selanjutnya, buat file pada directory tasks dengan nama codeigniter/tasks/main.yml , lalu isi perintah sebagai berikut :
  ...
  * Lalu langkah selanjutnya, buat file pada directory templates dengan nama codeigniter/templates/main.yml , lalu isi perintah sebagai berikut :
...
* Langkah selanjutnya yaitu buat directory laravel di direktori sudo mkdir laravel untuk mengakomodasi skrip yang memungkinkan untuk menginstal laravel framewrok.

  * Buat file dengan nama laravel/handlers/main.yml pada directory handlers, kemudain ketikkan script seperti dibawah ini :
  ...
  * Lalu, langkah selanjutnya yaitu buat file dengan nama laravel/tasks/main.yml pada directory tasks, kemudain ketikkan script seperti dibawah ini :
...
* Lalu, langkah selanjutnya yaitu buat folder dengan nama php untuk mengakomodasi instalasi php di peran laravel. Dalam peran ini, hanya perlu membuat 2 direktori bernama penangan dan tugas.

  * Buat beberapa file bernama php/handlers/main.yml pada direktori handlers Kemudian ketikkan script seperti di bawah ini :
  ...
  * Buat beberapa file bernama php/task/main.yml pada direktori tasks Kemudian ketikkan script seperti di bawah ini :
...
* Pada directory yii dibutuhkan 3 folder untuk menampung handlers, tasks, dan script template yang akan digunakan nantinya dalam menginstall yii
  ...
  * Buat file dengan nama yii/task/main.yml pada tasks directory, lalu tulis perintah sebagai berikut :
  ...
  * Kemudian, buat file lagi dengan nama yii/handlers/main.yml pada handlers directory, lalu tulis perintah sebagai berikut :
  ...
  * Kemudian, buat file lagi dengan nama yii/templates/yii.conf pada templates directory, lalu tulis perintah sebagai berikut :
